public class TestMain {
	public static void main(String[] args) {
		...
		Employee emp1 = new Employee("emp1", "Michael", 50000, 2000, 50, 3);
		Employee emp2 = new Employee("emp2", "Jim", 25000, 1400, 40, 1);
		Employee emp3 = new Employee("emp3", "Pam", 15000, 1000, 50, 4);
		Employee emp4 = new Employee("emp4", "Dwight", 25000, 1000, 40, 2);
